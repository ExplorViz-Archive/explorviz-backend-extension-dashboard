...
public final class MongoHelper { // NOPMD
	...
	private static final String DEFAULT_PORT = "7018";
	private static final String DEFAULT_DB = "explorviz";
	private static final String DASHBOARD_COLLECTION = "dashboard";
	...
	/**
	 * Returns a connection to the dashboard collection.
	 */
	public MongoCollection<Document> getDashboardCollection() {
		return this.getDatabase().getCollection(DASHBOARD_COLLECTION);
	}
